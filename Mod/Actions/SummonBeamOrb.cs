...
namespace AnyRadiance.Actions
{
    internal class SummonBeamOrb : Action
    {
        ...
        public SummonBeamOrb(bool bouncer, float bounceForce, float spinSpeed, float trackingAcceleration,
        ...
        public override IEnumerator Execute()
        {
            ...
            orbComponent.SetParams(_bouncer, _bounceForce, _spinSpeed, _trackingAcceleration, _maxTrackingSpeed, _numBeams, _beamInterval, _duration);
            if (_bounce)
            {
