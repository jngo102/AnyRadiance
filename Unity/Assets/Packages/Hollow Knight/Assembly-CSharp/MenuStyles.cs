...
public class MenuStyles : MonoBehaviour
{
	...
	public class MenuStyle
	{
		...
		public bool IsAvailable
		{
			get
			{
				if (unlockKey == "" || ((bool)GameManager.instance && GameManager.instance.gameConfig.unlockAllMenuStyles))
				{
					return enabled;
				}
				if (enabled)
				{
					return Platform.Current.EncryptedSharedData.GetInt(unlockKey, 0) == 1;
				}
				return false;
			}
		}
